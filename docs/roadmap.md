...
Track progress in [GitHub Issues](https://github.com/princejain756/MaintainerOS/issues).
...
- Keep MaintainerOS free and open source
- Prefer browser-first and local-first workflows
- Never store secrets in frontend code
- Focus on practical maintainer pain, not vanity metrics
